...
<html lang="en">
    <head>
        ...
        <link
            rel="shortcut icon"
            href="/images/icons8_paw_prints.ico"
            type="image/x-icon"
        />
    </head>
    <body>
        <nav class="navbar">
            <div class="navbar-container">
                <a href="/">
                    <img
                        src="images\icons8_paw_prints_40px.png"
                        alt="Website Logo. Two Paws"
                    />
                </a>
            ...
            <div class="form-container">
                ...
                <form action="register.php">
                    ...
                    <input
                        ...
                        required
                    />
                    <input class="btn btn-lg btn-primary m-10" type="submit" value="Register" />
                </form>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-left">
                        <h3>Quick Links</h3>
                        <p>
                            <a href="/">Home</a> | <a href="contact.html">Contact Us</a> |
                            <a href="blog.html">Posts</a> | <a href="services.html">Dog Services</a> |
                    ...
                    <div class="col-md-6 text-md-left">
                        <p>© Pawsitive Puppers 2023. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
